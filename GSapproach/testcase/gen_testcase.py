...
M = 32          # number of rows (samples) in input matrix D
N = 32             # number of columns (features) in input matrix
lrange = 0    # lrange <= element of matrix
urange = 256     # element of matrix <= urange
